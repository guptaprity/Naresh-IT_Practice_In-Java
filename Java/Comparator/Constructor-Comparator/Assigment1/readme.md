...
| Concept             | Description                               |
| ------------------- | ----------------------------------------- |
| `record`            | Java record used for immutable data class |
| Compact Constructor | Validates `pid`                           |
| `TreeSet`           | Stores unique sorted objects              |
| `Comparator`        | Custom sorting logic                      |
| Method Reference    | `Product::pid`, `Product::pname`          |
